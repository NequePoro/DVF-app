...
sudo -u admin psql -c "DROP DATABASE IF EXISTS dvf_202004;"
sudo -u admin psql -c "CREATE DATABASE dvf_202004;"
sudo -u admin psql -c "ALTER DATABASE dvf_202004 SET datestyle TO ""ISO, DMY"";"
sudo -u admin psql -d dvf_202004 -f "create_table.sql"
...
for YEAR in 2014 2015 2016 2017 2018 2019
do
  sudo -u admin psql -d dvf_202004 -c "COPY dvf FROM '$DATAPATH/full_$YEAR.csv' delimiter ',' csv header encoding 'UTF8';"
done

# Ajout d'une colonne et d'index - Assez long
sudo -u admin psql -d dvf_202004 -f "alter_table.sql"
